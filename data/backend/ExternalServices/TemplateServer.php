...
class TemplateServer implements ExternalServiceInterface
{
    protected APIClient $apiClient;
    protected static TemplateServer $instance;

    private function __construct()
    {
        $api_key = SystemConfig::globalVariables()['template_server']['api_key'];
        $url = SystemConfig::globalVariables()['template_server']['url'];
    ...
    public static function getInstance()
    {
        if (!isset(self::$instance)) {
            self::$instance = new TemplateServer();
        }
