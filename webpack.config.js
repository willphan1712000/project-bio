...
const entryjs = {
    ...
    checkoutjs: path.resolve(
        __dirname,
        'controllers/client/src/dist/checkout/checkout.js'
    ),
    userjs: path.resolve(__dirname, 'controllers/client/src/dist/user/user.js'),
    userTemplatejs: path.resolve(
        __dirname,
        'controllers/client/src/dist/user/userTemplate.js'
    ),
    adminjs: path.resolve(
        __dirname,
        'controllers/client/src/dist/admin/admin.js'
    ),
    adminDefaultjs: path.resolve(
        __dirname,
        'controllers/client/src/dist/default/admin.js'
    ),
    templatejs: path.resolve(
        __dirname,
        'controllers/client/src/dist/template/template.js'
    ),
    signupjs: path.resolve(
        __dirname,
