...
const data = [
    { name: 'Facebook', uv: 400, pv: 2400, amt: 2400 },
    { name: 'Instagram', uv: 200, pv: 2400, amt: 2400 },
    { name: 'Tiktok', uv: 890, pv: 2400, amt: 2400 },
];
...
const AppLineChart = () => {
    ...
    const {
        ...
        data: socialInfo,
        error,
    } = useAppQuery('analyticsSocial', apiDashboard.social);
    useAppEffect(error);
