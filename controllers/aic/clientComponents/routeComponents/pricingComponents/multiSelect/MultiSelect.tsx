...
const MultiSelect = () => {
    ...
    return (
        <div className="bg-white p-5 rounded-[30px] md:w-[700px] md:min-w-[700px] w-full">
            ...
            <div
                className="w-full rounded-[15px] h-[35px] border-black border-dashed border-[2px] flex flex-row justify-center items-center cursor-pointer"
                title="add a pricing model"
                onClick={handleClick}
            >
