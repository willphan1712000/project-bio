...
const Upload = () => {
    ...
    const handleUpload = async () => {
        if (!thumbnail || !template || !annotation) {
            toast(<AppToaster message="Please upload all required files" />);
            return;
        }
        ...
        if (!data.success) {
            ...
            if (!data.data.success) {
                ...
                toast(
                    <AppToaster message={data.data.data.msg} status={true} />
                );
            }
        }
            ...
            <div className={containerClasses}>
                <div className="flex flex-col md:flex-row justify-center items-center">
                    ...
                    <UploadArea
                        ...
                        state={{ file: template, setFile: setTemplate }}
                    />
                    <UploadArea
                        title="Upload Annotation"
                        state={{ file: annotation, setFile: setAnnotation }}
                    />
                </div>
