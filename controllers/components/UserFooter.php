        ...
        echo '
            ...
            <div id="share">
                ...
                <div class="options">
                    ...
                    <div class="share__btn edit" style="display: ' . (SystemConfig::URLExtraction(queryStr: 'share') ? "none" : "flex") . '"><a style="text-decoration: none; color: #000;" href="/@admin"><i class="fa-solid fa-pen-to-square"></i> Bio</a></div>
                </div>
            </div>
        ';
    }
