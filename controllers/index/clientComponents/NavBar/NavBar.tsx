        ...
        <div className="w-full">
            ...
            <div className="flex flex-col relative lg:hidden">
                <div className="w-full flex flex-row justify-between p-[10px] bg-white rounded-[30px]">
                    ...
                    <div
                        className="flex flex-col items-start justify-center text-[30px] cursor-pointer transition-all"
                        id="navBtn"
                    >
                        <i className="fa-solid fa-bars"></i>
                    </div>
                    <div
                        className="flex-col items-start justify-center text-[30px] cursor-pointer transition-all hidden"
                        id="navBtnClose"
                    >
                ...
                <div
                    className="bg-white p-5 rounded-[30px] absolute top-[110%] left-0 w-full z-[99] invisible"
                    id="nav"
                >
