...
const Template = () => {
    ...
    useEffect(() => {
        ...
        gsap.timeline({
            ...
            .fromTo(imgOne.current, { opacity: 0 }, { opacity: 1 })
            .to(imgOne.current, { opacity: 0 });
        ...
        gsap.timeline({
            ...
            .fromTo(imgTwo.current, { opacity: 0 }, { opacity: 1 })
            .to(imgOne.current, { opacity: 0 });
    }, [windowWidth]);
        ...
        return (
            <div className="flex bg-[#f5f5f7] rounded-3xl flex-row max-w-[1500px]">
                <div className="flex flex-col p-10 w-[60%]">
                    <Card
                        item={language.templates.basic}
                        ref={cardOne}
                        id="#basic_templates"
                    />
                    <Card
                        item={language.templates.pro}
                        ref={cardTwo}
                        id="#pro_templates"
                    />
                </div>
                <div className="flex w-[40%] sticky top-0 h-[100vh]">
                    <Image
                        url={'/controllers/client/img/background.png'}
                        ref={imgOne}
                    />
                    <Image
                        url={'/controllers/client/img/ip.png'}
                        ref={imgTwo}
                    />
                </div>
            </div>
