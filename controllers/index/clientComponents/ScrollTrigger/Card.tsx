...
const Card = React.forwardRef<CardRef, React.HTMLAttributes<HTMLDivElement>>(
    (props, ref) => {
        ...
        if (windowWidth <= mobile) {
            return (
                <div className="card-container" style={cardContainerStyle}>
                    ...
                    <Text
                        text={language.nfc.one}
                        ref={one}
                        className="bottom-[-70%] left-[0%] absolute w-[200px] z-10"
                    />
                    <Text
                        text={language.nfc.two}
                        ref={two}
                        className="bottom-[-60%] left-[10%] absolute w-[200px] z-10"
                    />
                    <Text
                        text={language.nfc.three}
                        ref={three}
                        className="bottom-[-80%] left-[20%] absolute w-[200px] z-10"
                    />
                </div>
            );
        }
        ...
        return (
            <div className="card-container" style={cardContainerStyle}>
                ...
                <Text
                    text={language.nfc.one}
                    ref={one}
                    className="top-[0] left-[400px] absolute w-[200px] z-10"
                    pointerDirection="left"
                />
                <Text
                    text={language.nfc.two}
                    ref={two}
                    className="top-0 left-[-250px] absolute w-[200px] z-10"
                    pointerDirection="right"
                />
                <Text
                    text={language.nfc.three}
                    ref={three}
                    className="top-[50px] left-[400px] absolute w-[200px] z-10"
                    pointerDirection="left"
                />
            </div>
        );
