    ...
    <div className="lg:p-[100px] p-[40px] flex flex-row justify-center max-w-[1500px]">
      <div className='flex lg:flex-row flex-col content-center w-full justify-between items-center'>
        <div className='flex flex-col lg:w-[70%] w-full'>
          <h1 className="text-[50px] font-bold">{language.heading.title}</h1>
          <p className="text-[25px] font-bold">{language.heading.des1}<span className="text-[25px] font-bold py-2 px-3 text-white bg-[--primary] rounded-full whitespace-nowrap overflow-hidden text-ellipsis">{language.heading.desSpan}</span>{language.heading.des2}</p>
