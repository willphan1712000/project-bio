        ...
        <div style={styles.container}>
            ...
            >
                <div className="overflow-hidden rounded-[30px] max-h-[700px] flex flex-col items-center">
                    <AppImage
                        src="/controllers/client/img/background.png"
                    ...
                    />
                    <div
                        className="absolute top-[10%] w-[80%] max-w-[800px]"
                        ref={greetingRef}
                    >
                        <Logo />
                    </div>
                ...
                <div className="px-10" ref={textRef}>
                    <h1 className="text-center text-[40px] text-black">
                        {language.heading.title}
                    </h1>
                    <h2 className="text-center text-white bg-[--primary] px-[15px] py-[5px] rounded-[40px] text-[40px]">
