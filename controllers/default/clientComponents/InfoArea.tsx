    ...
    return (
        <>
            <AdminContextProvider
                data={data}
                css={null}
                regex={extraData.regexMap}
                label={extraData.labelMap}
                iconMap={extraData.iconMap}
                setting={null}
            >
                <div className="info">
                ...
                <div id="social-media">
                    {orders.map((key) => (
                        <AdminElementContext.Provider key={key} value={key}>
                            <SocialTag key={key}></SocialTag>
                        </AdminElementContext.Provider>
                    ))}
