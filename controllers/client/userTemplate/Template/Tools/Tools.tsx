...
import { Raw_Info, UserInfo, UserPhone, UserSocial, User_Style } from '../../../types/User';
...
const Tools = () => {
  ...
  const [userStyle, setUserStyle] = useState<User_Style | undefined>(undefined)
  ...
  return (
    <div style={{
      ...
      {(icon && userInfo) && <IconBox name={icon} userInfo={userInfo} setUserInfo={setUserInfo}/>}
      {(text && userInfo) && <TextBox name={text} userInfo={userInfo} setUserInfo={setUserInfo}/>}
