...
/* harmony import */ var _module_W_js__WEBPACK_IMPORTED_MODULE_0__ =
    __webpack_require__(/*! ./module/W.js */ './src/module/W.js');
/* harmony import */ var _module_WW_js__WEBPACK_IMPORTED_MODULE_1__ =
    __webpack_require__(/*! ./module/WW.js */ './src/module/WW.js');
/* harmony import */ var _module_components_Cart_js__WEBPACK_IMPORTED_MODULE_2__ =
    __webpack_require__(
        /*! ./module/components/Cart.js */ './src/module/components/Cart.js'
    );
...
$(document).ready(function () {
    ...
    function runCheckDatabase() {
        $.ajax({
            ...
            success: function (e) {
                if (e) console.log('Database has been checked and updated');
            },
            error: function () {
                console.log('Error');
            },
    ...
    function signupPage() {
        (0, _module_W_js__WEBPACK_IMPORTED_MODULE_0__.$$)('#password')
            .passShowHide()
            .run();
        (0, _module_W_js__WEBPACK_IMPORTED_MODULE_0__.$$)(
            '.passRequirements',
            'dropdown'
        )
            .toggle()
            .run();
        (0, _module_WW_js__WEBPACK_IMPORTED_MODULE_1__.$$$)(
            '#username',
            '#email',
            '#password',
            '.signupChild__error',
    ...
    function bioPage() {
        ...
        $('.share__btn.image').click(() => {
            ...
            html2canvas(element, {
                ...
                document.querySelector('.image .shareWindow__qr').src =
                    canvas.toDataURL('image/png');
                document.querySelector(
                    '.image .shareWindow__download'
                ).download = 'card.png';
                document.querySelector('.image .shareWindow__download').href =
                    canvas.toDataURL('image/png');
    ...
    function adminPage() {
        ...
        // Add spinner
        const spinner = (0, _module_W_js__WEBPACK_IMPORTED_MODULE_0__.$$)(
            '.adminBtn__save'
        )
            .addSpinner()
            .singleSpinner();
        ...
        const upload = (0, _module_W_js__WEBPACK_IMPORTED_MODULE_0__.$$)(
            '.info__img--choose',
            '.info__img input'
        )
            .upload()
        ...
        $('.info__img input').on('change', (e) => {
            upload.fileHandling(e, function (src) {
                ...
                transform = (0, _module_W_js__WEBPACK_IMPORTED_MODULE_0__.$$)(
        ...
        if (typeof username === 'string') {
            $.ajax({
                ...
                success: function (e) {
                    const list = e[0];
                    if (list !== undefined) {
                        $('.info__img .uploadImg__filename').val(
                            list.image === null ? '' : list.image
                        );
                        $('.info__name #name').val(
                            list.name === null ? '' : list.name
                        );
                        $('.info__org #org').val(
                            list.organization === null ? '' : list.organization
                        );
                        $('.info__des #des').val(
        ...
        for (let i = 0; i < socialName.length; i++) {
            if (
                !(
                    socialName[i] === 'Mobile' ||
                    socialName[i] === 'Email' ||
                    socialName[i] === 'Messenger' ||
                    socialName[i] === 'Work'
                )
            ) {
                isValid[socialName[i]] = (0,
                _module_WW_js__WEBPACK_IMPORTED_MODULE_1__.$$$)(
                    '.' + socialName[i] + ' #social__info',
                    '.' + socialName[i] + ' span',
        ...
        isValid.Mobile = (0, _module_WW_js__WEBPACK_IMPORTED_MODULE_1__.$$$)(
            '.Mobile #social__info',
            '.Mobile span',
            '<i style="color:green;" class="fa-solid fa-check"></i>',
            '<i style="color:red;" class="fa-solid fa-x"></i>',
        ...
        isValid.Work = (0, _module_WW_js__WEBPACK_IMPORTED_MODULE_1__.$$$)(
            '.Work #social__info',
            '.Work span',
            '<i style="color:green;" class="fa-solid fa-check"></i>',
            '<i style="color:red;" class="fa-solid fa-x"></i>',
        ...
        isValid.Zalo = (0, _module_WW_js__WEBPACK_IMPORTED_MODULE_1__.$$$)(
            '.Zalo #social__info',
            '.Zalo span',
            '<i style="color:green;" class="fa-solid fa-check"></i>',
            '<i style="color:red;" class="fa-solid fa-x"></i>',
        ...
        // Email Validation
        isValid.Email = (0, _module_WW_js__WEBPACK_IMPORTED_MODULE_1__.$$$)(
            '.Email #social__info',
            '.Email span',
            '<i style="color:green;" class="fa-solid fa-check"></i>',
            '<i style="color:red;" class="fa-solid fa-x"></i>',
        ...
        isValid.Messenger = (0, _module_WW_js__WEBPACK_IMPORTED_MODULE_1__.$$$)(
        ...
        // Address Validation
        isValid.Address = (0, _module_WW_js__WEBPACK_IMPORTED_MODULE_1__.$$$)(
                ...
                for (let i = 0; i < socialName.length; i++) {
                    if (socialName[i] === 'Messenger') {
                        ...
                        if (value === '') {
                            ...
                            listForUpdate[socialName[i]] =
                                `${code} ${dial} ${$('.' + socialName[i] + ' #social__info').val()}`;
                        }
                    } else {
                        listForUpdate[socialName[i]] = $(
                            '.' + socialName[i] + ' #social__info'
        ...
        $.ajax({
            ...
            success: function (userArray) {
                ...
                for (let i = 0; i < userArray.length; i++) {
                    userArray[i].bioLink =
                        `<a target="_blank" href="/${userArray[i].username}" style="color: #000;">Bio</a>`;
                    userArray[i].admin =
                        `<a target="_blank" href="/${userArray[i].username}/admin" style="color: #000;">Admin</a>`;
                    userArray[i].delete =
                        `<button value="${userArray[i].username}">Delete</button>`;
    ...
    function resetPass() {
        (0, _module_W_js__WEBPACK_IMPORTED_MODULE_0__.$$)('#password')
            .passShowHide()
            .run();
        (0, _module_W_js__WEBPACK_IMPORTED_MODULE_0__.$$)('#verifyPassword')
            .passShowHide()
            .run();
    }
    ...
    function template(props) {
        ...
        const cartComponentInstance = (0,
        _module_components_Cart_js__WEBPACK_IMPORTED_MODULE_2__.cartComponent)({
            container: '.logo',
            cart: cart,
            cartEle: '.cart',
        })
