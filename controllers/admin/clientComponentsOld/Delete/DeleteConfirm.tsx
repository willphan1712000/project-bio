    ...
    if (state.show)
        return (
            <div
                ...
                className="z-[99] fixed top-0 left-0 w-screen h-screen backdrop-blur-sm flex justify-center items-center"
            >
                <div
                    onClick={(e) => handleStop(e)}
                    ref={deleteMenuRef}
                    className="rounded-[10px] bg-white max-w-[600px] w-[80%] h-[70%] shadow-2xl flex justify-center items-center flex-col p-[15px]"
                >
                    ...
                    <div className="flex flex-row gap-5 mt-5">
                        <button
                            ...
                            className="flex flex-row justify-center items-center rounded-xl bg-[#f0f0f0] p-2"
                        >
                            <ClipLoader
                                size="20px"
                                color="#000"
                        ...
                        {!state.disabled && (
                            <button
                                onClick={(e) => handleCancel(e)}
                                className="rounded-xl bg-[#c3e676] p-2"
                            >
                                Cancel
                            </button>
                        )}
