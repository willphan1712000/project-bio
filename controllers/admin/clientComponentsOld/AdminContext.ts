...
export type Action = {
    type: 'upload' | 'main' | 'preview' | 'delete';
    value?: string;
};
...
export type SaveAction = {
    type: 'submit' | 'show' | 'message' | 'disable' | 'default';
    value?: string;
};

type Delete =
    | [state: DeleteState, action: React.Dispatch<DeleteAction>]
    | undefined;
...
type Setting =
    | [state: SettingState, action: React.Dispatch<SettingAction>]
    | undefined
    | null;
