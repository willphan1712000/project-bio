...
const AvatarFrame = () => {
    ...
    function handleAccept() {
        ...
        const [, src, srcEncoded] = canvasObj.drawImage(
            img,
            ctx,
            x,
            y,
    ...
    const jsx = (
        <div
            className={`flex h-[100dvh] w-screen fixed top-0 left-0 backdrop-blur-[20px] z-[99] flex-col justify-center items-center px-[30px]`}
        >
            <p className="text-[20px] mb-[20px]">Drag, Zoom, or Rotate Image</p>
            <div
                className="frame relative w-[100%] max-w-[500px] max-h-[500px] aspect-square border-dashed border-black border-4 rounded-[50%] p-[50px] overflow-hidden bg-white"
                ref={frameRef}
            >
            ...
            <div className="btn flex flex-row gap-6 mt-[20px] z-0">
                <div
                    ...
                    className="flex items-center accept rounded-[10px] bg-[#f0f0f0f0] p-[10px] shadow-lg cursor-pointer"
                >
                    Accept
                </div>
                <div
                    onClick={() => handleCancel()}
                    className="cancel rounded-[10px] bg-[#f0f0f0f0] p-[10px] shadow-lg cursor-pointer"
                >
                    Cancel
                </div>
            </div>
