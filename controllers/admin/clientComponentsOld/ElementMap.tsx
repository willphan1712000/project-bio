...
export function Email() {
    return <FontAwesomeIcon icon={faEnvelope} size="3x" />;
}

export function Mobile() {
    return <FontAwesomeIcon icon={faPhone} size="3x" />;
}

export function Booking() {
    return <Image src="/controllers/client/img/booking.png" />;
}

export function OrderOnline() {
    return <Image src="/controllers/client/img/order.png" />;
}

export function HotSale() {
    return <Image src="/controllers/client/img/hotsales.png" />;
}

export function Address() {
    return <FontAwesomeIcon icon={faLocationDot} size="3x" />;
}
...
export function Threads() {
    return <i className="fa-brands fa-threads"></i>;
}
...
export function Viber() {
    return <i className="fa-brands fa-viber"></i>;
}
...
export function Zalo() {
    return <Image src="/controllers/client/img/zalo.png" />;
}
...
export function Website() {
    return <FontAwesomeIcon icon={faGlobe} size="3x" />;
}
