...
const CountryCodeIcon = ({ buttonRef, onCallBack }: Props) => {
    ...
    return (
        <div
            onClick={() => onCallBack()}
            className="countryCode p-[2px] flex flex-row rounded-[10px] bg-white h-auto mr-[5px] cursor-pointer"
            data-index
            data-flag
            data-code
            ref={buttonRef}
        >
            <div className="flag w-[40px] p-[5px] !flex items-center">
                <img
                    ...
                    src={`/controllers/admin/clientComponents/CountryCode/flags/${flag.toLowerCase()}.png`}
                />
            </div>
